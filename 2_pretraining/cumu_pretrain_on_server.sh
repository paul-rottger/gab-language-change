...
for train_month in "09" "10" "11" "12"; do
...
python run_mlm.py \
    --model_name_or_path $DATA/gab-language-change/adapted-models/reddit/cumu-models/bert-cumu_2018_12_1m \
    --train_file $DATA/gab-language-change/0_data/clean/unlabelled_reddit/month_splits/train_2019_01_1m.txt \
    --validation_file $DATA/gab-language-change/0_data/clean/unlabelled_reddit/total/test_rand_10k.txt \
    --save_steps 20000 \
    --use_special_tokens \
    --line_by_line \
    ...
    --per_device_train_batch_size 64 \
    --dataset_cache_dir $DATA/gab-language-change/z_cache/datasets \
    --output_dir $DATA/gab-language-change/adapted-models/reddit/cumu-models/bert-cumu_2019_01_1m \
    --overwrite_output_dir \
    --num_train_epochs 1 \
    --max_seq_length 128
